...
public class Alerts {
	...
	private boolean Drone_Crashed_Alarm, Package_Delivered_indicator;
	private int shield_damage_count, esr_persistence_count; 
	private boolean pod_damaged; 
	private boolean em_shield_deploy_latch;
	private double rand_value;
	private boolean package_not_delivered;
	
	public boolean isPackage_not_delivered() {
		return package_not_delivered;
	}
	public void setPackage_not_delivered(boolean package_not_delivered) {
